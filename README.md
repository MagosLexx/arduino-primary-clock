u# Arduino Clock Driver with DS3231 RTC
...
## 🎯 Заключение
- Следует понимать что успех реализации проекта зависит в том числе и от состояния механизма самих часов. Если механизм находится в неудовлетворительном состоянии (грязь, ржавчина), то возможны пропуски хода, нечёткое срабатывание и прочее. 
- В данном проекте отсутствуют органы управления для электронного перевода стрелок, т.к. RTC-модуль обеспечивает точный ход
